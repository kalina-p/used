...
while True:
    # sprawdza czy guzik na stronie "dodaj do koszyka" jest aktywny. Jeżeli nie to niech zrobi refresh strony i ponownie zrobi petle
    czy_aktywny_koszyk == True
    print("pierwsza")
    time.sleep(5)
    window.refresh()
    if czy_aktywny_koszyk != True: 
        # jeżeli guzik jest aktywny wtedy wykonaj poniższe czynności
        print("druga")
